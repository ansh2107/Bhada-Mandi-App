...
public class DistanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_distance_locator, null);

        e1 = (AutoCompleteTextView) v.findViewById(R.id.dist_1);
        e2 = (AutoCompleteTextView) v.findViewById(R.id.dist_2);

        e1.setAdapter(new GooglePlacesAutocompleteAdapter(getActivity(), R.layout.list_item));
        //  from.setOnItemClickListener((AdapterView.OnItemClickListener) getActivity());

        e2.setAdapter(new GooglePlacesAutocompleteAdapter(getActivity(), R.layout.list_item));
        //  to.setOnItemClickListener((AdapterView.OnItemClickListener) getActivity());

        but = (Button) v.findViewById(R.id.dist_but);
        t = (TextView) v.findViewById(R.id.dist_txt);
        but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lat1 == 0.0 || lat2 == 0.0 || long1 == 0.0 || long2 == 0.0) {
                    ...
                    s1 += " km";
                    t.setText(s1);
                    Toast.makeText(getActivity(), "Distance is " + s1, Toast.LENGTH_SHORT).show();
                }
            }
        });
